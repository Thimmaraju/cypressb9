...
describe('Verify Login Functionality', () => {
 ...
 // let endpoint = "/web/index.php/auth/login"
  ...
  it.only('Writing Data or Extarcting Data ', () => {
    ...
    cy.get('input[class="oxd-input oxd-input--active"]').last().type("0070");
    ...
    cy.xpath('//div[@class="oxd-table-card"]/div/div[3]/div').then((txt)=>{
       ...
       // var empname = txt.text();
        ...
        // cy.log(empname)
        cy.writeFile('cypress/fixtures/module3/test.txt', txt.text())
        cy.writeFile('cypress/fixtures/module3/employee.json', { firstname: txt.text()});
