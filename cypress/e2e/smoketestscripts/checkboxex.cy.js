describe('checkbox Test', function () {
    ...
    it('Working with Check boxes', function (){
       ...
       cy.xpath('//input[starts-with(@name,"chk_altemail")]', {timeout:20000}).should('be.checked');
       cy.wait(10000)

       cy.xpath('//input[starts-with(@name,"chk_altemail")]').uncheck()
       ...
       cy.xpath('//input[@value="m"]', {timeout:20000}).check().should('be.checked');
